...
// Source: AssetTools.NET/Extra/AssetClassID.cs (pinned 9aa8c6e)
package com.github.jpabscale.asset4j.typetree

/**
 * Unity asset class IDs (mirrors the C# `AssetClassID` enum).
 */
enum class AssetClassID(val id: Int) {
    Object(0),
    GameObject(1),
    Component(2),
    LevelGameManager(3),
    ...
    companion object {
        fun fromId(id: Int): AssetClassID? = entries.firstOrNull { it.id == id }
    }
}
